function schroederReverb3()
    % --- UI Setup ---
    fig = figure('Name', 'Schroeder Reverb', 'NumberTitle', 'off', 'Position', [300, 200, 400, 250]);
    movegui(fig, 'center');
    ...
    function updateReverb(~, ~) 
        ...
        combDelays = round([500, 800, 1200, 1500] * (1 + reverbIntensity));
        combGains = [0.7, 0.6, 0.5, 0.4] * (1 - 0.2 * reverbIntensity);
        combMixes = [0.5, 0.4, 0.3, 0.2] * (1 - 0.3 * reverbIntensity);
